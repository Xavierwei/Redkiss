    ...
    var ImageFrameSource = function () {
      function ImageFrameSource(config) {
        ...
        this.largeUrlFunc = function (n, prefix) {
          ...
          var fileDir = "PICS/mobile/";
          return SH.Config.isMobile ? fileDir = "/large_960/" : SH.Config.isTablet && (fileDir = "/large_960/"), config.path + "/mobile/" + config.prefix + SH.Util.zeroPad(n, config.frameNumberTemplate || "" + n) + "." + config.extension
        ...
        return Story.getStory = function (id) {
          ...
          if (openStory && openStory.hide(), openStory = this, !this.visible) {
            ...
            // var el = this.$el,
              ...
              //czhang 自动播放
              var stopAtPage = jumpToPage + 30 + delta;
